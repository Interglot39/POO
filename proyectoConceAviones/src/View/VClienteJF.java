 ...
 * @author tatom
 */
public class VClienteJF extends javax.swing.JFrame {

    /**
     * Creates new form VClienteJF
     */
    public VClienteJF() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VClienteJF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VClienteJF().setVisible(true);
            }
        });
    }
